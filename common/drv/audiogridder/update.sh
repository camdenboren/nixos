#!/usr/bin/env nix
#!nix shell nixpkgs#coreutils nixpkgs#curl nixpkgs#htmlq nixpkgs#jq nixpkgs#perl nixpkgs#gitMinimal --command bash
...
package_file="$repo_root/common/drv/audiogridder/default.nix"
