...
in
{
  programs.freetube = {
    ...
    settings = {
      ...
      hideHeaderLogo = true;
      mainColor = if (hostname == "medial") then "Teal" else "Red";
      ...
      defaultProfile = lib.mkIf (hostname == "media") "C8kpmytTeH7aRdKy";
      defaultTheatreMode = true;
      displayVideoPlayButton = false;
      externalPlayer = "mpv";
      externalPlayerExecutable = lib.mkIf isDarwin "/Users/camdenboren/.nix-profile/bin/mpv";
